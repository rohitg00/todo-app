...
:::note
This node environments uses ESM by default, for CJS React environment, head to the [teambit.react/react-env](https://bit.cloud/teambit/react/react-env) environment
:::
...
```
bit env set my-component bitdev.react/react-env
```
...
```
bit new react my-workspace --aspect bitdev.react/react-env
```
