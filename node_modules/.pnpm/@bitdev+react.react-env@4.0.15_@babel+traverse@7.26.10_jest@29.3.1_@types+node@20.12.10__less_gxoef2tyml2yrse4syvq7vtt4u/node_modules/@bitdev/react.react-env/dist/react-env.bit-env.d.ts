...
export declare class ReactEnv implements ReactEnvInterface {
    /**
    ...
    protected envCurrentPath: string;
    protected tsconfigPath: string;
    protected tsTypesPath: string;
    protected get types(): string[];
    protected jestConfigPath: string;
    protected vitestConfigPath: string;
    ...
    protected previewDocsTemplate: string;
    protected previewViteConfig: string;
    /**
...
declare const _default: ReactEnv;
