...
const toolbox_path_path_1 = require("@teambit/toolbox.path.path");
...
function configFactory(devServerID, workspaceDir, entryFiles, publicRoot, publicPath, pubsub, title, favicon) {
    ...
    return {
        ...
        output: {
            ...
            devtoolModuleFilenameTemplate: (info) => (0, toolbox_path_path_1.pathNormalizeToLinux)(path_1.default.resolve(info.absoluteResourcePath)),
