...
export const Preview = () => {
    return (_jsx("div", { style: { height: 400, width: 600 }, children: _jsx(Playground, { code: codeString }) }));
};
export const HorizontalExample = () => {
    return (_jsx("div", { style: { height: 400, width: 600 }, children: _jsx(Playground, { code: longFunction }) }));
};
export const VerticalExample = () => {
    return (_jsx("div", { style: { height: 450, width: 400 }, children: _jsx(Playground, { code: longFunction }) }));
};
export const Nested = () => {
    const scope = { Playground };
    return (_jsxs("div", { style: { height: 400, width: 600 }, children: ["(currently broken, hover-splitter breaks when in nested in another split-spane)", _jsx(Playground, { code: nested, scope: scope })] }));
};
