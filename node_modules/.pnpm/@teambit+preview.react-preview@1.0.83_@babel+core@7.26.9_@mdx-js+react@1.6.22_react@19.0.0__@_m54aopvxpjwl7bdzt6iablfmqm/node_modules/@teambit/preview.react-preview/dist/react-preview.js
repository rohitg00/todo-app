...
const webpack_caching_transformer_1 = require("./webpack-caching.transformer");
class ReactPreview {
    ...
    getDevServer(context) {
        ...
        return webpack_webpack_dev_server_1.WebpackDevServer.from({
            ...
            transformers: [
                ...
                (0, webpack_caching_transformer_1.createCacheControlTransformer)(),
                ...this.transformers,
            ],
        });
    }
