...
const webpack_modules_config_mutator_1 = require("@teambit/webpack.modules.config-mutator");
...
class WebpackBundler {
    ...
    static create(options, aspectContext) {
        ...
        const configs = options.targets.map((target) => {
            ...
            const configMutator = new webpack_modules_config_mutator_1.WebpackConfigMutator(baseConfig);
