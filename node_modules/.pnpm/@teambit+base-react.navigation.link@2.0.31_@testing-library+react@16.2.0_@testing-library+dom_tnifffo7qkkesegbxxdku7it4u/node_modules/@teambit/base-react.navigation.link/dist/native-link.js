...
exports.NativeLink = (0, react_1.forwardRef)(function NativeLink(_a, ref) {
    var { className, style, activeClassName, activeStyle, active, strict, exact, href, external, 
    // unused, but excluded from ...rest:
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    native, 
    // unused, but excluded from ...rest:
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    state } = _a, rest = __rest(_a, ["className", "style", "activeClassName", "activeStyle", "active", "strict", "exact", "href", "external", "native", "state"]);
    ...
    return (react_1.default.createElement("a", Object.assign({}, externalProps, rest, { ref: ref, href: href, className: (0, classnames_1.default)(className, isActive && activeClassName), style: combinedStyles })));
});
