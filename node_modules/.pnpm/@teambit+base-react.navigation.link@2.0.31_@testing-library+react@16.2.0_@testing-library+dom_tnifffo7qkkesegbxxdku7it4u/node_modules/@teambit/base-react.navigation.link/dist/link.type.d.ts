 ...
 */
export declare type LinkType = ComponentType<LinkProps>;
/**
...
export interface LinkProps extends BaseLinkProps, RefAttributes<HTMLAnchorElement>, AnchorHTMLAttributes<HTMLAnchorElement> {
}
export declare type Location<StateType = {}> = {
...
export declare type UseLocation<StateType extends {} = {}> = () => Location<StateType>;
...
export declare type UseNavigate = () => Navigator;
